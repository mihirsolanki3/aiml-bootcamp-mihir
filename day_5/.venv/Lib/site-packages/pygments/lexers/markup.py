...
class RstLexer(RegexLexer):
    ...
    def _handle_sourcecode(self, match):
        ...
        yield from _shift_indices(
            do_insertions(ins, lexer.get_tokens_unprocessed(code)), match.start(8)
        )
...
class TiddlyWiki5Lexer(RegexLexer):
    ...
    def _handle_codeblock(self, match):
        ...
        yield from _shift_indices(
            do_insertions([], lexer.get_tokens_unprocessed(code)), match.start(4)
        )
    ...
    def _handle_cssblock(self, match):
        ...
        yield from _shift_indices(
            do_insertions([], lexer.get_tokens_unprocessed(code)), match.start(3)
        )
