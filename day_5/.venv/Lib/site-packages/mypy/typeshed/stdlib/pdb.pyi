...
def run(  # matches `builtins.exec`
    statement: str | ReadableBuffer | CodeType,
...
class Pdb(Bdb, Cmd):
    ...
    if sys.version_info >= (3, 13):
        @property
        @deprecated(
            "The frame locals reference is no longer cached. Use 'curframe.f_locals' instead."
        )
    ...
    if sys.version_info >= (3, 14):
        def checkline(
            ...
            filename: str,
            lineno: int,
            module_globals: _ModuleGlobals | None = None,
        ) -> int: ...
    else:
    ...
    if sys.version_info >= (3, 15):
        def print_stack_entry(
            self, frame_lineno: tuple[FrameType, int], prompt_prefix: str | None = None
        ) -> None: ...
    else:
        def print_stack_entry(
    ...
    if sys.version_info >= (3, 14):
        ...
        def do_break(
            self, arg: str, temporary: bool | Literal[0, 1] = 0
        ) -> bool | None: ...
