...
class RawConfigParser(_Parser):
    ...
    @overload
    def read(
        self, filenames: GenericPath[AnyStr], encoding: str | None = None
    ) -> list[AnyStr]: ...
    @overload
    def read(
        self, filenames: Iterable[StrPath], encoding: str | None = None
    ) -> list[str]: ...
    @overload
    def read(
        self, filenames: Iterable[BytesPath], encoding: str | None = None
    ) -> list[bytes]: ...
    @overload
    def read(
        self, filenames: Iterable[StrOrBytesPath], encoding: str | None = None
    ) -> list[str | bytes]: ...
...
if sys.version_info < (3, 12):
    @deprecated(
        "Deprecated since Python 3.2; removed in Python 3.12. Use `ConfigParser` instead."
    )
...
class ParsingError(Error):
    ...
    if sys.version_info >= (3, 13):
        ...
        @overload
        @deprecated(
            "The `filename` parameter removed in Python 3.12. Use `source` instead."
        )
    ...
    if sys.version_info < (3, 12):
        @property
        @deprecated(
            "Deprecated since Python 3.2; removed in Python 3.12. Use `source` instead."
        )
