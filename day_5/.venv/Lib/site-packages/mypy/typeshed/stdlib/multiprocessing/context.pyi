...
class BaseContext:
    ...
    if sys.version_info >= (3, 15):
        def set_forkserver_preload(
            ...
            *,
            on_error: Literal["ignore", "warn", "fail"] = "ignore",
        ) -> None: ...
    else:
...
if sys.platform != "win32":
    def get_spawning_popen() -> (
        popen_forkserver.Popen | popen_spawn_posix.Popen | None
    ): ...
    def set_spawning_popen(
        popen: popen_forkserver.Popen | popen_spawn_posix.Popen | None,
    ) -> None: ...
