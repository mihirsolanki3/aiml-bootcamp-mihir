...
if sys.version_info >= (3, 13):
    class _BaseDictProxy(BaseProxy, MutableMapping[_KT, _VT]):
        ...
        if sys.version_info >= (3, 14):
            ...
            @overload
            def fromkeys(
                self, iterable: Iterable[_T], value: None = None, /
            ) -> dict[_T, Any | None]: ...
            @overload
            def fromkeys(
                self, iterable: Iterable[_T], value: _S, /
            ) -> dict[_T, _S]: ...
...
class BaseListProxy(BaseProxy, MutableSequence[_T]):
    ...
    def __delitem__(
        self, i: SupportsIndex | slice[SupportsIndex | None], /
    ) -> None: ...
    @overload
    ...
    @overload
    def __setitem__(
        self, s: slice[SupportsIndex | None], o: Iterable[_T], /
    ) -> None: ...
