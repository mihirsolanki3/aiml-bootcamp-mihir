...
class Listener:
    ...
    if sys.platform != "win32":
        ...
        def accept(
            ...
            Connection[Incomplete, Incomplete] | PipeConnection[Incomplete, Incomplete]
        ): ...
...
if sys.version_info >= (3, 12):
    def deliver_challenge(
        connection: _ConnectionBase[Any, Any],
        authkey: bytes,
    ...
    def deliver_challenge(
        connection: _ConnectionBase[Any, Any], authkey: bytes
    ) -> None: ...

def answer_challenge(connection: _ConnectionBase[Any, Any], authkey: bytes) -> None: ...
def wait(
    object_list: Iterable[
        _ConnectionBase[_SendT_contra, _RecvT_co] | socket.socket | int
    ],
