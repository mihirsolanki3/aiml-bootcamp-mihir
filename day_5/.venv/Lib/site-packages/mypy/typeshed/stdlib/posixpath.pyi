...
if sys.version_info >= (3, 15):
    @overload
    def realpath(
        filename: PathLike[AnyStr], /, *, strict: bool | _AllowMissingType = False
    ) -> AnyStr: ...
    @overload
    def realpath(
        filename: AnyStr, /, *, strict: bool | _AllowMissingType = False
    ) -> AnyStr: ...
...
if sys.version_info >= (3, 15):
    ...
    def splitdrive(
        p: AnyOrLiteralStr, /
    ) -> tuple[AnyOrLiteralStr, AnyOrLiteralStr]: ...
