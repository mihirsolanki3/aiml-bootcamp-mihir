...
class GeneratorType(Generator[_YieldT_co, _SendT_contra, _ReturnT_co]):
    ...
    if sys.version_info >= (3, 15):
        ...
        def gi_state(
            self,
        ) -> Literal["GEN_CREATED", "GEN_SUSPENDED", "GEN_RUNNING", "GEN_CLOSED"]: ...
    __name__: str
    __qualname__: str
...
class AsyncGeneratorType(AsyncGenerator[_YieldT_co, _SendT_contra]):
    ...
    if sys.version_info >= (3, 15):
        ...
        def ag_state(
            ...
            "AGEN_CREATED", "AGEN_SUSPENDED", "AGEN_RUNNING", "AGEN_CLOSED"
        ]: ...
...
class CoroutineType(Coroutine[_YieldT_co, _SendT_nd_contra, _ReturnT_nd_co]):
    ...
    if sys.version_info >= (3, 15):
        ...
        def cr_state(
            ...
            "CORO_CREATED", "CORO_SUSPENDED", "CORO_RUNNING", "CORO_CLOSED"
        ]: ...
