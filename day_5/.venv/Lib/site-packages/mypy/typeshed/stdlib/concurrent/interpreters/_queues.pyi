...
if sys.version_info >= (3, 14):  # needed to satisfy pyright checks for Python <= 3.13
    from _interpqueues import (
        ...
        QueueNotFoundError as QueueNotFoundError,
    )
    ...
    class ItemInterpreterDestroyed(
        QueueError, _crossinterp.ItemInterpreterDestroyed
    ): ...
    ...
    class Queue:
        ...
        def put_nowait(
            self, obj: object, *, unbounditems: _AnyUnbound | None = None
        ) -> None: ...
        if sys.version_info >= (3, 14):
            def get(
                self,
            ...
            def get(
                self, timeout: SupportsIndex | None = None, *, _delay: float = 0.01
            ) -> object: ...
