...
class type:
    ...
    def __or__(
        self: _typeshed.Self, value: Any, /
    ) -> types.UnionType | _typeshed.Self: ...
    def __ror__(
        self: _typeshed.Self, value: Any, /
    ) -> types.UnionType | _typeshed.Self: ...
...
class float:
    ...
    if sys.version_info >= (3, 14):
        @classmethod
        def from_number(
            cls, number: float | SupportsIndex | SupportsFloat, /
        ) -> Self: ...
...
class str(Sequence[str]):
    ...
    @overload
    def __new__(
        cls, object: ReadableBuffer, encoding: str = "utf-8", errors: str = "strict"
    ) -> Self: ...
...
class bytes(Sequence[int]):
    ...
    def translate(
        self, table: ReadableBuffer | None, /, delete: ReadableBuffer = b""
    ) -> bytes: ...
...
class memoryview(Sequence[_I]):
    ...
    @overload
    def __setitem__(
        self, key: slice[SupportsIndex | None], value: ReadableBuffer, /
    ) -> None: ...
    @overload
    def __setitem__(
...
class list(MutableSequence[_T]):
    ...
    @overload
    def __setitem__(
        self, key: slice[SupportsIndex | None], value: Iterable[_T], /
    ) -> None: ...
    def __delitem__(
        self, key: SupportsIndex | slice[SupportsIndex | None], /
    ) -> None: ...
...
class dict(MutableMapping[_KT, _VT]):
    ...
    if sys.version_info >= (3, 15):
        @overload
        def __or__(
            self, value: dict[_KT, _VT] | frozendict[_KT, _VT], /
        ) -> dict[_KT, _VT]: ...
        @overload
        def __or__(
            self, value: dict[_T1, _T2] | frozendict[_T1, _T2], /
        ) -> dict[_KT | _T1, _VT | _T2]: ...
        @overload
...
if sys.version_info >= (3, 15):
    ...
    class frozendict(Mapping[_KT, _VT]):
        ...
        @overload
        def __new__(
            cls: type[frozendict[str, _VT]], /, **kwargs: _VT
        ) -> frozendict[str, _VT]: ...
        @overload
        def __new__(
            cls, map: SupportsKeysAndGetItem[_KT, _VT], /
        ) -> frozendict[_KT, _VT]: ...
        @overload
        def __new__(
            cls: type[frozendict[str, _VT]],
            map: SupportsKeysAndGetItem[str, _VT],
            /,
            **kwargs: _VT,
        ) -> frozendict[str, _VT]: ...
        @overload
        def __new__(
            cls, iterable: Iterable[tuple[_KT, _VT]], /
        ) -> frozendict[_KT, _VT]: ...
        @overload
        def __new__(
            cls: type[frozendict[str, _VT]],
        ...
        def fromkeys(
            cls, iterable: Iterable[_T], value: None = None, /
        ) -> frozendict[_T, Any | None]: ...
        @overload
        @classmethod
        def fromkeys(
            cls, iterable: Iterable[_T], value: _S, /
        ) -> frozendict[_T, _S]: ...
        @overload  # type: ignore[override]
        def get(self, key: _KT, default: None = None, /) -> _VT | None: ...
        @overload
...
class map(Iterator[_S]):
    ...
    if sys.version_info >= (3, 14):
        ...
        @overload
        def __new__(
            cls, func: Callable[[_T1], _S], iterable: Iterable[_T1], /
        ) -> Self: ...
        @overload
        def __new__(
            cls,
...
class zip(Iterator[_T_co]):
    ...
    @overload
    def __new__(
        cls, iter1: Iterable[_T1], /, *, strict: bool = False
    ) -> zip[tuple[_T1]]: ...
    @overload
    def __new__(
...
class AttributeError(Exception):
    def __init__(
        self, *args: object, name: str | None = None, obj: object = None
    ) -> None: ...
    name: str | None
    obj: object
...
class ImportError(Exception):
    def __init__(
        self, *args: object, name: str | None = None, path: str | None = None
    ) -> None: ...
    name: str | None
    path: str | None
...
if sys.version_info >= (3, 11):
    ...
    class BaseExceptionGroup(BaseException, Generic[_BaseExceptionT_co]):
        ...
        def subgroup(
            self,
            matcher_value: type[_BaseExceptionT] | tuple[type[_BaseExceptionT], ...],
            /,
