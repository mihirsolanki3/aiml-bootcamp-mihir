...
class Mailbox(Generic[_MessageT_co]):
    ...
    def __init__(
        self,
        path: StrPath,
        factory: Callable[[_GetFileReturn], _MessageT_co],
        create: bool = True,
    ) -> None: ...
    @overload
    def __init__(
    ...
    def update(
        ...
        arg: (
            _HasIteritems
            | SupportsItems[str, _MessageData]
...
class Maildir(Mailbox[MaildirMessage]):
    ...
    def __init__(
        self,
        dirname: StrPath,
        factory: Callable[[_GetFileReturn], MaildirMessage] | None = None,
        create: bool = True,
    ) -> None: ...
...
class mbox(_mboxMMDF[mboxMessage]):
    def __init__(
        self,
        path: StrPath,
        factory: Callable[[_GetFileReturn], mboxMessage] | None = None,
        create: bool = True,
    ) -> None: ...
...
class MMDF(_mboxMMDF[MMDFMessage]):
    def __init__(
        self,
        path: StrPath,
        factory: Callable[[_GetFileReturn], MMDFMessage] | None = None,
        create: bool = True,
    ) -> None: ...
...
class MH(Mailbox[MHMessage]):
    def __init__(
        self,
        path: StrPath,
        factory: Callable[[_GetFileReturn], MHMessage] | None = None,
        create: bool = True,
    ) -> None: ...
    def add(self, message: _MessageData) -> str: ...
    def remove(self, key: str) -> None: ...
...
class Babyl(_singlefileMailbox[BabylMessage]):
    def __init__(
        self,
        path: StrPath,
        factory: Callable[[_GetFileReturn], BabylMessage] | None = None,
        create: bool = True,
    ) -> None: ...
...
class _PartialFile(_ProxyFile):
    def __init__(
        self, f: _GetFileReturn, start: int | None = None, stop: int | None = None
    ) -> None: ...
