...
if sys.version_info >= (3, 15):
    ...
    def b64encode(
        s: ReadableBuffer, altchars: ReadableBuffer | None = None
    ) -> bytes: ...
    def b64decode(
        s: str | ReadableBuffer,
        altchars: str | ReadableBuffer | None = None,
...
if sys.version_info >= (3, 15):
    ...
    def urlsafe_b64decode(
        s: str | ReadableBuffer, *, padded: bool = False
    ) -> bytes: ...
    def b32encode(
        s: ReadableBuffer, *, padded: bool = True, wrapcol: int = 0
    ) -> bytes: ...
    def b32decode(
        s: str | ReadableBuffer,
        casefold: bool = False,
...
if sys.version_info >= (3, 15):
    ...
    def b85encode(
        b: ReadableBuffer, pad: bool = False, *, wrapcol: int = 0
    ) -> bytes: ...
    def b85decode(
        b: str | ReadableBuffer,
        *,
...
def decode(
    input: SupportsNoArgReadline[bytes], output: SupportsWrite[bytes]
) -> None: ...
...
if sys.version_info >= (3, 13):
    if sys.version_info >= (3, 15):
        def z85encode(
            s: ReadableBuffer, pad: bool = False, *, wrapcol: int = 0
        ) -> bytes: ...
        def z85decode(
            s: str | ReadableBuffer,
            *,
