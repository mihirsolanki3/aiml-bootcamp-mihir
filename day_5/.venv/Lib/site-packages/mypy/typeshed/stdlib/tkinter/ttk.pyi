...
class _Layout(TypedDict, total=False):
    ...
    sticky: (
        str  # consists of letters 'n', 's', 'w', 'e', may contain repeats, may be empty
    )
...
if sys.platform == "win32" and sys.version_info >= (3, 13):
    ...
    _ElementCreateArgs: (
        ...
        | tuple[
            Literal["vsapi"], str, int, _VsapiStatespec, _ElementCreateVsapiKwargsDict
        ]
    )
else:
...
class Style:
    ...
    def theme_create(
        ...
        settings: _ThemeSettings | None = None,
    ) -> None: ...
