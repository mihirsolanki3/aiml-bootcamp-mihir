...
class Variable:
    def __init__(
        self, master: Misc | None = None, value=None, name: str | None = None
    ) -> None: ...
...
class Misc:
    ...
    def grid_anchor(
        self,
        anchor: (
            Literal["nw", "n", "ne", "w", "center", "e", "sw", "s", "se"] | None
        ) = None,
    ) -> None: ...
    anchor = grid_anchor
...
class Tk(Misc, Wm):
    ...
    if sys.platform != "win32":
        def createfilehandler(
            self, file: FileDescriptorLike, mask: int, func: Callable[..., object], /
        ) -> None: ...
...
class Canvas(Widget, XView, YView):
    def __init__(
        ...
        *,
        ...
        scrollregion: (
            tuple[float | str, float | str, float | str, float | str] | tuple[()]
        ) = (),
    ...
    def find_enclosed(
        self, x1: float | str, y1: float | str, x2: float | str, y2: float | str
    ) -> tuple[int, ...]: ...
    def find_overlapping(
        self, x1: float | str, y1: float | str, x2: float | str, y2: float
    ) -> tuple[int, ...]: ...
    ...
    def canvasx(
        self, screenx: float | str, gridspacing: float | str | None = None
    ) -> float: ...
    def canvasy(
        self, screeny: float | str, gridspacing: float | str | None = None
    ) -> float: ...
    @overload
...
class Text(Widget, XView, YView):
    ...
    def dlineinfo(
        self, index: str | float | _tkinter.Tcl_Obj | Widget
    ...
    def image_cget(
        ...
        option: Literal["image", "name"],
    ) -> str: ...
    @overload
    def image_cget(
        self,
        index: str | float | _tkinter.Tcl_Obj | Widget,
        option: Literal["padx", "pady"],
    ) -> int: ...
    @overload
    def image_cget(
    ...
    @overload
    def image_cget(
        self, index: str | float | _tkinter.Tcl_Obj | Widget, option: str
    ) -> Any: ...
    @overload
    def image_configure(
    ...
    def mark_set(
        self, markName: str, index: str | float | _tkinter.Tcl_Obj | Widget
    ) -> None: ...
    ...
    def tag_add(
        ...
        tagName: str,
        index1: str | float | _tkinter.Tcl_Obj | Widget,
        *args: str | float | _tkinter.Tcl_Obj | Widget,
    ) -> None: ...
    ...
    def tag_names(
        self, index: str | float | _tkinter.Tcl_Obj | Widget | None = None
    ) -> tuple[str, ...]: ...
    def tag_nextrange(
        self,
        tagName: str,
