...
class NullTranslations:
    ...
    if sys.version_info < (3, 11):
        ...
        @deprecated(
            "Deprecated since Python 3.8; removed in Python 3.11. Use `gettext()` instead."
        )
...
if sys.version_info >= (3, 11):
    ...
    @overload
    @deprecated(
        "The `codeset` parameter is deprecated since Python 3.8; removed in Python 3.11."
    )
    def install(
        domain: str,
        localedir: StrPath | None,
...
if sys.version_info < (3, 11):
    ...
    @deprecated(
        "Deprecated since Python 3.8; removed in Python 3.11. Use `dgettext()` instead."
    )
    ...
    @deprecated(
        "Deprecated since Python 3.8; removed in Python 3.11. Use `dngettext()` instead."
    )
