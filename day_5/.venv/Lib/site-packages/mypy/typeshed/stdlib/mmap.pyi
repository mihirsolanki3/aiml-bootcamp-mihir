...
class mmap:
    ...
    if sys.version_info >= (3, 15):
        def flush(
            self, offset: int = 0, size: int = ..., /, *, flags: int = 0
        ) -> None: ...
    else:
    ...
    if sys.platform != "win32":
        def seek(
            self, pos: int, whence: Literal[0, 1, 2, 3, 4] = os.SEEK_SET, /
        ) -> None: ...
    else:
    ...
    if sys.platform != "win32":
        if sys.version_info >= (3, 15):
            def madvise(
                self, option: int, start: int = 0, length: int | None = None, /
            ) -> None: ...
        else:
            def madvise(
                self, option: int, start: int = 0, length: int = ..., /
            ) -> None: ...
    ...
    if sys.version_info >= (3, 15):
        ...
        def find(
            self, view: ReadableBuffer, start: int = ..., end: int = ..., /
        ) -> int: ...
        def rfind(
            self, view: ReadableBuffer, start: int = ..., end: int = ..., /
        ) -> int: ...
    ...
    def __exit__(
        self, exc_type: Unused, exc_value: Unused, traceback: Unused, /
    ) -> None: ...
