...
class accumulate(Iterator[_T]):
    @overload
    def __new__(
        cls, iterable: Iterable[_T], func: None = None, *, initial: _T | None = None
    ) -> Self: ...
    @overload
    def __new__(
        cls,
...
class zip_longest(Iterator[_T_co]):
    ...
    @overload
    def __new__(
        cls, iter1: Iterable[_T1], /, *, fillvalue: object = None
...
class permutations(Iterator[_T_co]):
    ...
    @overload
    def __new__(
        cls, iterable: Iterable[_T], r: int | None = None
...
if sys.version_info >= (3, 12):
    ...
    class batched(Iterator[_T_co], Generic[_T_co]):
        if sys.version_info >= (3, 13):
            @overload
            def __new__(
                cls, iterable: Iterable[_T], n: Literal[1], *, strict: Literal[True]
            ) -> batched[tuple[_T]]: ...
            @overload
            def __new__(
                cls, iterable: Iterable[_T], n: Literal[2], *, strict: Literal[True]
            ) -> batched[tuple[_T, _T]]: ...
            @overload
            def __new__(
            ...
            @overload
            def __new__(
                cls, iterable: Iterable[_T], n: int, *, strict: bool = False
            ) -> batched[tuple[_T, ...]]: ...
        else:
            def __new__(
                cls, iterable: Iterable[_T], n: int
            ) -> batched[tuple[_T, ...]]: ...
