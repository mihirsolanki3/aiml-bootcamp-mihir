...
class ZstdCompressor:
    ...
    def compress(
        ...
        data: ReadableBuffer,
        mode: (
            _ZstdCompressorContinue
            | _ZstdCompressorFlushBlock
            | _ZstdCompressorFlushFrame
        ) = 0,
    ) -> bytes: ...
    def flush(
...
class ZstdDict:
    def __new__(
        cls, dict_content: ReadableBuffer, /, *, is_raw: bool = False
    ) -> Self: ...
...
def set_parameter_types(
    c_parameter_type: type[CompressionParameter],
    d_parameter_type: type[DecompressionParameter],
) -> None: ...
def train_dict(
