...
if sys.version_info >= (3, 14):
    ...
    class CField(Generic[_CT, _GetT, _SetT]):
        ...
        @overload
        def __get__(
            self, instance: None, owner: builtins.type[Any] | None = None, /
        ) -> Self: ...
        @overload
        def __get__(
            self, instance: Any, owner: builtins.type[Any] | None = None, /
        ) -> _GetT: ...
...
class Array(_CData, Generic[_CT], metaclass=_PyCArrayType):
    ...
    @overload
    def __setitem__(
        self, key: slice[SupportsIndex | None], value: Iterable[Any], /
    ) -> None: ...
