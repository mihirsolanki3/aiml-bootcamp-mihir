...
class Shape:
    def __init__(
        self,
        type_: Literal["polygon", "image", "compound"],
        data: _PolygonCoords | PhotoImage | None = None,
    ) -> None: ...
    def addcomponent(
...
class TurtleScreen(TurtleScreenBase):
    def __init__(
        self,
        cv: Canvas,
        mode: Literal["standard", "logo", "world"] = "standard",
        colormode: float = 1.0,
        delay: int = 10,
    ) -> None: ...
    def clear(self) -> None: ...
...
class TNavigator:
    ...
    def __init__(
        self, mode: Literal["standard", "logo", "world"] = "standard"
    ) -> None: ...
    def reset(self) -> None: ...
...
class TPen:
    def __init__(
        self, resizemode: Literal["auto", "user", "noresize"] = "noresize"
    ) -> None: ...
    @overload
...
def onclick(
    fun: Callable[[float, float], object], btn: int = 1, add: bool | None = None
) -> None: ...
