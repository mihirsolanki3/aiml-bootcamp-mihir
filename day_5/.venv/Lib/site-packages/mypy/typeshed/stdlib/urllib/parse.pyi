...
if sys.version_info >= (3, 15):
    ...
    class DefragResult(
        _DefragResultBase[str, _StrComponentT], _ResultMixinStr, Generic[_StrComponentT]
    ): ...
    class SplitResult(
        _SplitResultBase[str, _StrComponentT],
        _NetlocResultMixinStr,
        Generic[_StrComponentT],
    ): ...
    class ParseResult(
        _ParseResultBase[str, _StrComponentT],
        _NetlocResultMixinStr,
        Generic[_StrComponentT],
    ): ...
    # Structured result objects for bytes data
    class DefragResultBytes(
        _DefragResultBase[bytes, _BytesComponentT],
        _ResultMixinBytes,
        Generic[_BytesComponentT],
    ): ...
    class SplitResultBytes(
        _SplitResultBase[bytes, _BytesComponentT],
        _NetlocResultMixinBytes,
        Generic[_BytesComponentT],
    ): ...
    class ParseResultBytes(
        _ParseResultBase[bytes, _BytesComponentT],
        _NetlocResultMixinBytes,
        Generic[_BytesComponentT],
    ): ...
...
if sys.version_info >= (3, 15):
    @overload
    def urldefrag(
        url: str, *, missing_as_none: Literal[True]
    ) -> DefragResult[str | None]: ...
    @overload
    def urldefrag(
        url: str, *, missing_as_none: Literal[False] = False
    ) -> DefragResult[str]: ...
    @overload
    def urldefrag(
        url: bytes | bytearray | None, *, missing_as_none: Literal[True]
    ) -> DefragResultBytes[bytes | None]: ...
    @overload
    def urldefrag(
        url: bytes | bytearray | None, *, missing_as_none: Literal[False] = False
    ) -> DefragResultBytes[bytes]: ...
    @overload
    def urldefrag(url: str, *, missing_as_none: bool) -> DefragResult[str | None]: ...
    @overload
    def urldefrag(
        url: bytes | bytearray | None, *, missing_as_none: bool
    ) -> DefragResultBytes[bytes | None]: ...
...
class _QuoteVia(Protocol):
    @overload
    def __call__(
        self, string: str, safe: str | bytes, encoding: str, errors: str, /
    ) -> str: ...
    @overload
...
if sys.version_info >= (3, 15):
    ...
    @overload
    def urlunparse(
        components: Iterable[AnyStr | None], *, keep_empty: bool = ...
    ) -> AnyStr: ...
