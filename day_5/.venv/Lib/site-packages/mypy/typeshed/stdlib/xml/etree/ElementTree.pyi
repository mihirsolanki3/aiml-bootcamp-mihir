...
class Element(Generic[_Tag]):
    ...
    @overload
    def __setitem__(
        self, key: slice[SupportsIndex | None], value: Iterable[Element[Any]], /
    ) -> None: ...
...
def SubElement(
    parent: Element[Any], tag: str, attrib: dict[str, str] = ..., **extra: str
) -> Element: ...
def Comment(text: str | None = None) -> Element[_ElementCallable]: ...
def ProcessingInstruction(
    target: str, text: str | None = None
) -> Element[_ElementCallable]: ...
...
class ElementTree(Generic[_Root]):
    def __init__(
        self, element: Element[Any] | None = None, file: _FileRead | None = None
    ) -> None: ...
...
def indent(
    tree: Element[Any] | ElementTree[Any], space: str = "  ", level: int = 0
) -> None: ...
def parse(
...
_EventT_co = TypeVar(
    "_EventT_co",
    bound=Element[str] | Element[_ElementCallable] | tuple[str, str] | None,
    covariant=True,
)
...
@overload
def iterparse(
    source: _FileRead, events: Iterable[_EventType]
) -> _IterParseIterator[Any]: ...
@overload
def iterparse(
    source: _FileRead, events: None = None
) -> _IterParseIterator[Element[str]]: ...
...
def iterparse(
    source: _FileRead, events: Iterable[_EventType], parser: XMLParser | None = None
) -> _IterParseIterator[Any]: ...
...
class XMLPullParser(Generic[_EventT_co]):
    def __init__(
        self,
        events: Iterable[_EventType] | None = None,
        *,
        _parser: XMLParser[_EventT_co] | None = None,
    ) -> None: ...
