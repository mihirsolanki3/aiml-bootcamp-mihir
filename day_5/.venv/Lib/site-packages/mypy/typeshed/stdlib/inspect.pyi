...
def isdatadescriptor(
    object: object,
) -> TypeIs[_SupportsSet[Never, Never] | _SupportsDelete[Never]]: ...
...
if sys.version_info >= (3, 15):
    def getdoc(
        object: object,
        *,
        inherit_class_doc: bool = True,
        fallback_to_class_doc: bool = True,
    ) -> str | None: ...
...
if sys.version_info >= (3, 15):
    def getfullargspec(
        func: object, *, annotation_format: Format = Format.VALUE
    ) -> FullArgSpec: ...  # noqa: Y011
...
@deprecated(
    "Deprecated since Python 3.5. Use `Signature.bind` and `Signature.bind_partial` instead."
)
def getcallargs(
