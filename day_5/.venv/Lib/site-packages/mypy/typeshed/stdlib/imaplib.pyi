...
if sys.version_info >= (3, 14):
    class Idler:
        ...
        def __enter__(self) -> Self: ...
        def __exit__(
            self, exc_type: object, exc_val: Unused, exc_tb: Unused
        ) -> Literal[False]: ...
        def __iter__(self) -> Self: ...
        def __next__(self) -> tuple[str, float | None]: ...
        def burst(
            self, interval: float = 0.1
        ) -> Generator[tuple[str, float | None]]: ...
...
class IMAP4_SSL(IMAP4):
    ...
    if sys.version_info >= (3, 14):
        @property
        @deprecated(
            "IMAP4_SSL.file is unsupported, can cause errors, and may be removed."
        )
...
class IMAP4_stream(IMAP4):
    ...
    if sys.version_info >= (3, 14):
        @property
        @deprecated(
            "IMAP4_stream.file is unsupported, can cause errors, and may be removed."
        )
        def file(self) -> IO[Any]: ...
    else:
        file: IO[Any]
