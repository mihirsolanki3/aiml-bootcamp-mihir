...
class PurePath(PathLike[str]):
    ...
    @deprecated(
        "Deprecated since Python 3.14; will be removed in Python 3.19. Use `Path.as_uri()` instead."
    )
    def as_uri(self) -> str: ...
    ...
    if sys.version_info >= (3, 14):
        ...
        @overload
        @deprecated(
            "Passing additional arguments is deprecated since Python 3.12; removed in Python 3.14."
        )
