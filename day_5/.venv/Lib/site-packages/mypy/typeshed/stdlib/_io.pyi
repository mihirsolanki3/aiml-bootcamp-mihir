...
class BufferedReader(BufferedIOBase, _BufferedIOBase, BinaryIO, Generic[_BufferedReaderStreamT]):  # type: ignore[misc]  # incompatible definitions of methods in the base classes
    ...
    if sys.version_info >= (3, 14):
        def __init__(
            self, raw: _BufferedReaderStreamT, buffer_size: int = 131072
        ) -> None: ...
    else:
        def __init__(
            self, raw: _BufferedReaderStreamT, buffer_size: int = 8192
        ) -> None: ...
...
_BufferedWriterStreamT = TypeVar(
    "_BufferedWriterStreamT", bound=_BufferedWriterStream, default=_BufferedWriterStream
)
...
class BufferedWriter(BufferedIOBase, _BufferedIOBase, BinaryIO, Generic[_BufferedWriterStreamT]):  # type: ignore[misc]  # incompatible definitions of writelines in the base classes
    ...
    if sys.version_info >= (3, 14):
        def __init__(
            self, raw: _BufferedWriterStreamT, buffer_size: int = 131072
        ) -> None: ...
    else:
        def __init__(
            self, raw: _BufferedWriterStreamT, buffer_size: int = 8192
        ) -> None: ...
...
class BufferedRWPair(
    BufferedIOBase,
    _BufferedIOBase,
    Generic[_BufferedReaderStreamT, _BufferedWriterStreamT],
):
    if sys.version_info >= (3, 14):
        def __init__(
            self,
            reader: _BufferedReaderStreamT,
            writer: _BufferedWriterStreamT,
