...
class ExpandTypeVisitor(TrivialSyntheticTypeTranslator):
    ...
    def visit_param_spec(self, t: ParamSpecType) -> Type:
        ...
        if isinstance(repl, ParamSpecType):
            ...
            assert isinstance(t.upper_bound, ProperType) and isinstance(
                t.upper_bound, Instance
            )
            ...
            if kind == ArgKind.ARG_POS and name is None:
                ...
                if isinstance(type, UnpackType):
                    ...
                    optional_posargs.append(
                        UnpackType(Instance(tuple_type.type, [type]))
                    )
                break
    ...
    @classmethod
    def _possible_callable_kwargs(
        cls, repl: Parameters, dict_type: Instance
    ) -> ProperType:
        ...
        return TypedDictType(
            kwargs, required_names, set(), dict_type, is_closed=is_closed
        )
