...
class AppDataDisabled(AppData):
    ...
    def py_info(
        self, path: Path
    ) -> ContentStoreNA:  # ruff:ignore[unused-method-argument]
    ...
    def extract(
        self, path: Path, to_folder: Path | None
    ) -> NoReturn:  # ruff:ignore[unused-method-argument]
        raise self.error

    @contextmanager
    def locked(
        self, path: Path
    ) -> Generator[None]:  # ruff:ignore[unused-method-argument]
        """Do nothing."""
        yield
    ...
    def wheel_image(
        self, for_py_version: str, name: str
    ) -> NoReturn:  # ruff:ignore[unused-method-argument]
        raise self.error
