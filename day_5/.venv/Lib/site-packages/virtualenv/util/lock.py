...
class _CountedFileLock(FileLock):
    ...
    ) -> None:  # ruff:ignore[boolean-default-value-positional-argument]
...
class PathLockBase(ABC):
    ...
    ) -> Iterator[None]:  # ruff:ignore[boolean-default-value-positional-argument]
        raise NotImplementedError
...
class NoOpFileLock(PathLockBase):
    ...
    def lock_for_key(
        ...
        None
    ]:  # ruff:ignore[unused-method-argument, boolean-default-value-positional-argument]
        yield

    @contextmanager
    def non_reentrant_lock_for_key(
        self, name: str
    ) -> Iterator[None]:  # ruff:ignore[unused-method-argument]
        yield
