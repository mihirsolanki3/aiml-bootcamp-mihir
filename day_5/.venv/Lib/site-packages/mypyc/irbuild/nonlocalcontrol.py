...
def gen_class_clear_on_completion(
    builder: IRBuilder, obj: Value, cl: ClassIR, line: int
) -> None:
...
def gen_generator_func_cleanup(builder: IRBuilder, line: int) -> None:
    ...
    gen_class_clear_on_completion(
        builder, cls.curr_env_reg, builder.fn_info.env_class, line
    )
