...
def make_builder(
    *,
    ...
    for module in native_modules:
        group_map[module] = (
            "current-group" if module in same_group_modules else "other-group"
        )
...
class TestStatementHelpers(unittest.TestCase):
    ...
    def test_split_import_group_to_python_and_native_preserves_runs(self) -> None:
        ...
        group = [
            ...
            Import(
                [("pkg.beta", "beta_alias"), ("foreign.mod", None), ("pkg.gamma", None)]
            ),
        ]
        group[0].line = 10
        group[1].line = 20
    ...
    def test_classify_import_from_treats_missing_name_under_native_parent_as_attr(
        self,
    ) -> None:
    ...
    def test_classify_import_from_without_native_parent_never_uses_native_attr(
        self,
    ) -> None:
        builder = make_builder()
