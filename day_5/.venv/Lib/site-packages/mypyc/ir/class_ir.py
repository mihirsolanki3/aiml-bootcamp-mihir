...
class ClassIR:
    ...
    def serialize(self) -> JsonDict:
        return {
            ...
            "attrs_to_keep_alive_on_completion": sorted(
                self.attrs_to_keep_alive_on_completion
            ),
            ...
            "env_user_function": (
                self.env_user_function.id if self.env_user_function else None
            ),
    ...
    def deserialize(cls, data: JsonDict, ctx: DeserMaps) -> ClassIR:
        ...
        ir.attrs_to_keep_alive_on_completion = set(
            data["attrs_to_keep_alive_on_completion"]
        )
