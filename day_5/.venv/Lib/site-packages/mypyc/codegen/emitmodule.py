...
from mypyc.analysis.capsule_deps import (
...
class GroupGenerator:
        ...
        if self.compiler_options.separate:
            ...
            for group in sorted(self.context.group_deps):
                ...
                emitter.emit_lines(
                    ...
                    "memcpy(&exports_{g}, pexports_{g}, sizeof(exports_{g}));".format(
                        g=egroup
                    ),
                )
    ...
    def emit_coroutine_wrappers(
        ...
        for fn in module.functions:
            ...
            emitter.emit_line(
                f'PyObject *{name_obj} = PyUnicode_FromString("{fn.name}");'
            )
    ...
    def emit_module_init_func(
        ...
        emitter.emit_line(
            f'PyObject *ext_suffix = PyUnicode_FromString("{EXT_SUFFIX}");'
        )
    ...
    def module_internal_static_name(self, module_name: str, emitter: Emitter) -> str:
        return emitter.static_name(
            module_name + "__internal", None, prefix=MODULE_PREFIX
        )
