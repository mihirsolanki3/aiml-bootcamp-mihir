...
def _parse_spec_pattern(string_spec: str) -> PythonSpec | None:
    ...
    debug = (
        True if groups["debug"] else None
    )  # unconstrained unless an explicit d/-dbg/-debug marker is present
...
class PythonSpec:
    ...
    def generate_re(
        self, *, windows: bool, all_implementations: bool = False
    ) -> re.Pattern:
        """
    ...
    def satisfies(
        self, spec: PythonSpec
    ) -> bool:  # ruff:ignore[too-many-return-statements]
        """
